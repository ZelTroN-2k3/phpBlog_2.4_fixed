...
$run   = mysqli_query($connect, "SELECT * FROM `posts` WHERE active='Yes' AND publish_datetime <= NOW() ORDER BY id DESC LIMIT $rows, $postsperpage");
...
';
    ...
    $query   = "SELECT COUNT(id) AS numrows FROM posts WHERE active='Yes' AND publish_datetime <= NOW()";
